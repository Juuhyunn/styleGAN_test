...
def absolute_variable_scope(scope: str, **kwargs) -> tf.Module:
    """Forcefully enter the specified variable scope, ignoring any surrounding scopes."""
    return tf.Module(tf.Module(name=scope, **kwargs), auxiliary_name_scope=False)
...
def create_session(config_dict: dict = None, force_as_default: bool = False) -> tf.function:
    ...
    # Create session.
    session = tf.function(config=config_proto)
    if force_as_default:
